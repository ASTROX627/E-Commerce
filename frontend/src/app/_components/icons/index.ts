...
export { default as IconAlt } from './src/alt';
...
export { default as IconShowPass } from './src/show-pass';
export { default as IconSignin } from './src/Signin';
export { default as IconVector } from './src/Vector';